...
```{r Position tracker and storer, message=FALSE, warning=FALSE, include=FALSE}
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = rookFinal, aes(x = Turns, color = Position)) + geom_density(data = rookFinal, aes(fill = Position), alpha = 0.5) + theme_classic() + labs(title = "Distribution of Number of Moves for a Rook to Return to its Starting Position", x = "Numer of Moves", y = "Density") + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(data = rookFinal, aes(xintercept = MeanTurns, color = Position), linetype="dashed", size = 1)
```

###### Knight Distributions

For the knight, there is a much wider range of what the mean number of turns it took to return to the pieces original position which in turn also makes the shapes of the distributions different. Based on this, it seems like the starting postion for a knight affects how many turns it would take to return its original position. 
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = knightFinal, aes(x = Turns, color = Position)) + geom_density(data = knightFinal, aes(fill = Position), alpha = 0.5) + theme_classic() + labs(title = "Distribution of Number of Moves for a Knight to Return to its Starting Position", x = "Numer of Moves", y = "Density") + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(data = knightFinal, aes(xintercept = MeanTurns, color = Position), linetype="dashed", size = 1)
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
ggplot(data = queenFinal, aes(x = Turns, color = Position)) + geom_density(data = queenFinal, aes(fill = Position), alpha = 0.5) + theme_classic() + labs(title = "Distribution of Number of Moves for a Queen to Return to its Starting Position", x = "Numer of Moves", y = "Density") + theme(plot.title = element_text(hjust = 0.5)) + geom_vline(data = queenFinal, aes(xintercept = MeanTurns, color = Position), linetype="dashed", size = 1)
```
